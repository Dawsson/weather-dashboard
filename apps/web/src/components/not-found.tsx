...
export function Illustration(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
      ...
      {...props}
    >
      <title id="illustrationTitle">Illustration of a not found page</title>
      <path
  ...
  return (
    <div className="relative flex min-h-[60svh] w-full flex-col justify-center bg-background p-6 md:p-10">
      <div className="relative mx-auto w-full max-w-5xl">
        <Illustration className="absolute inset-0 h-[40vh] w-full text-foreground opacity-[0.04] dark:opacity-[0.03]" />
